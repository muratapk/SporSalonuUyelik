...
namespace SporSalonuUyelik.Controllers
{
    public class AntrenorsController : Controller
    {
        ...
        public AntrenorsController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,AdSoyad,UzmanlikAlani,Telefon,Email")] Antrenor antrenor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AdSoyad,UzmanlikAlani,Telefon,Email")] Antrenor antrenor)
        {
            if (id != antrenor.Id)
            {
                return NotFound();
